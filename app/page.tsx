...
export default function Home() {
  ...
  <div
      ...
      style={{
        ...
        right: '20px',
        background: '#04AA6D',
        boxShadow: '0 0 8px 0 #c2c2c2',
        zIndex: 99999, // Remove !important as it's not needed in inline styles
      }}
    >
      <a target="_blank" style={{ textDecoration: 'none' }} href="https://wa.me/923371112221">
        <svg
          style={{
            all: 'unset',
