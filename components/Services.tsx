      ...
      >
        {TrustBadgesInfo.map((item, index: number) => (
          <div
            ...
            className='trust-badge translate-y-[1000px] flex md:mx-0 mx-4 text-center flex-col bg-darkblue rounded-lg items-center justify-center p-6'
            key={index}
          >
            <div className='bg-white p-4 rounded-full  m-4'>
